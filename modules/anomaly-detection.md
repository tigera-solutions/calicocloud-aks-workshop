...
Instructions below for a Managed cluster only. Follow [configuration documentation](https://docs.tigera.io/v3.11/threat/anomaly-detection/customizing) to configure AD jobs for management and standalone clusters.
...
4. Simulate anomaly by using an NMAP port scan above the threshold set in our Deployment env vars listed in Step 1.
	...
	Nmap scan report for 10.240.0.44
	Host is up.
	All 600 scanned ports on 10.240.0.44 are filtered

	Nmap done: 1 IP address (1 host up) scanned in 121.32 seconds
	```
